const CACHE_NAME = 'foodie-v1.0.0';
const urlsToCache = [
  '/',
  '/index.html',
  '/manifest.json',
...
self.addEventListener('push', event => {
  ...
  const options = {
    body: event.data ? event.data.text() : 'Your food order has been updated!',
  ...
  event.waitUntil(
    self.registration.showNotification('Foodie - Order Update', options)
  );
});
...
async function updateMenuCache() {
  ...
  // This would fetch latest menu data and update cache
  return Promise.resolve();
}